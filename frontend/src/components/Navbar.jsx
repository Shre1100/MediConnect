    ...
    return(
        <div className=" flex bg-white items-center justify-between mt-2 rounded-lg text-sm py-4 pr-7 mb-5 border-b border-b-gray-400 h-[60px] shadow-lg shadow-slate-900/20 shadow-b-3 shadow-r-[3px] -shadow-spread-2">
          ...
          <ul className="hidden md:flex justify-evenly gap-14 items-start font-semibold">
            ...
            <NavLink to='/'>
                <li className="py-1 text-[1.04rem]">Home</li>
                <hr className="border-none outline-none h-0.5 bg-primary m-auto hidden"/>
            </NavLink>
            <NavLink to='/doctors'>
                <li className="py-1 text-[1.04rem]">Doctors</li>
                <hr className="border-none outline-none h-0.5 bg-primary m-auto hidden"/>
            </NavLink>
            <NavLink to='/about'>
                <li className="py-1 text-[1.04rem]">About Us</li>
                <hr className="border-none outline-none h-0.5 bg-primary m-auto hidden"/>
            </NavLink>
            <NavLink to='/contact'>
                <li className="py-1 text-[1.04rem]">Contact</li>
                <hr className="border-none outline-none h-0.5 bg-primary m-auto hidden"/>
            </NavLink>
          </ul>
